            ...
            ZStack {
                ForEach(cardViews) { cardView in
                    cardView
                        ...
                        .scaleEffect(self.dragState.isDragging && self.isTopCard(cardView: cardView) ? 0.88 : 1.0)
                        .rotationEffect(Angle(degrees: self.isTopCard(cardView: cardView) ? Double(self.dragState.translation.width / 12) : 0))
                        .animation(.interpolatingSpring(stiffness: 120, damping: 120), value: dragState.isDragging ? true : false)
